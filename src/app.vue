  ...
  <div class="h-full bg-white flex flex-col justify-between">
    <header class="absolute inset-x-0 top-0 z-50">
      <nav
        ...
        aria-label="Global"
      >
        <div class="flex lg:flex-[33%] sm:flex-1">
          <a
            href="#"
            class="-m-1.5 p-1.5"
          >
        ...
        >
          <svg
            class="h-[20px] w-[20px] text-black"
            viewBox="0 0 100 100"
        ...
        <div class="py-12 sm:py-36">
          <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl">
              <h1 class="text-5xl font-bold tracking-tight text-gray-900 sm:text-6xl flex flex-col items-start">
                <span>TypeScript</span>
                <span class="inline-block -my-4 text-transparent leading-snug bg-clip-text bg-gradient-to-br from-[#395ef9] to-[#ff32ab]">
                  performance
                </span>
                <span>made easy</span>
              </h1>
              <div class="mt-6 flex flex-col gap-6">
                <span class="tracking-tight text-lg ">
                ...
                <ul class="flex flex-row flex-wrap gap-8 justify-between bg-gray-100 rounded px-8 pt-6 pb-5 -m-0.5 mt-2">
                  <li class="flex flex-col gap-2 items-center flex-[33%] sm:flex-1">
                    <div class="bg-[#6754e8] text-xl p-3 rounded text-white">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="1em"
                        height="1em"
                ...
                <span class="mt-8 tracking-tight max-w-md">
                  Want to know when you can try it? We'll send you an email
                  just before we launch.
                </span>
                <div class="max-w-7xl">
                  <form
                    class="mx-auto mt-2 flex bg-black rounded-md"
                  ...
                  >
                    ...
                    <input
                      ...
                      autoComplete="email"
                      required
                      class="min-w-0 flex-auto rounded-l-md rounded-r-none px-2 py-2 border-black border-2 focus:ring-1 focus:ring-inset focus:ring-transparent sm:text-sm sm:leading-6 -mr-0.5"
                      placeholder="Enter your email"
                    >

                    <button
                      type="submit"
                      class="w-[120px] flex justify-center items-center rounded-r-md bg-black flex-none text-white px-4 py-2.5 font-semibold hover:bg-gray-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
                    >
                      <div
                        v-if="status === 'loading'"
                        role="status"
                  ...
                  <p
                    v-if="status === 'error'"
                    class="text-xs text-red-500 mt-1 text-left"
                  >
    ...
    <footer>
      <div class="py-6 md:order-1 md:mt-0 space-y-1">
